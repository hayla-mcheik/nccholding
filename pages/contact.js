...
<nav aria-label="breadcrumb pt-5">
  <ol class="breadcrumb pt-5">
    ...
    <li class="breadcrumb-item active text-uppercase" aria-current="page">Contact Us</li>
  </ol>
</nav>
</div>
...
<div class="container gk-form"><h3 class="text-uppercase">CONTACT US </h3><p>Our friendly team would love to hear from you!</p>
<form action="">
